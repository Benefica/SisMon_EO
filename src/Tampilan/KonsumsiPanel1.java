 ...
 * @author Rizki Ananda
 */
public class KonsumsiPanel1 extends javax.swing.JInternalFrame {
    ...
    ResultSet rs;
    /**
     * Creates new form KonsumsiPanel1
     */
    public KonsumsiPanel1(Pembayaran frame) {
        initComponents();
        tabelKonsumsi();
        this.f = frame;
    }
    ...
    private void tabelKonsumsiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelKonsumsiMouseClicked
        ...
        this.f.tJenisMenu2.setText(tabelKonsumsi.getModel().getValueAt(baris, 0).toString());
        this.f.tTypeMenu2.setText(tabelKonsumsi.getModel().getValueAt(baris, 1).toString());
